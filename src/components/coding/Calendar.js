                ...
                new tradingView.widget(
                    {
                        ...
                        "save_image": false,
                        "container_id": "tradingview_66f5f"
                    }
                )
                ...
                <Grid item container xs={12} justify='space-between'>
                    ...
                    <Grid item container xs={6} justify='center'>
                        <div className={`slide-container ${classes.quotesContainer}`}>
                            <Fade
                                ...
                                arrows={false}
                            >
                                <div className={`each-fade ${classes.quotes}`}>
                    ...
                    <Grid item xs={3}>
                        <div className="tradingview-widget-container">                  
                            <div id="tradingview_66f5f"></div>
                            <div className="tradingview-widget-copyright"><a href="https://www.tradingview.com/symbols/ETHUSD/?exchange=BITSTAMP" rel="noopener"><span className="blue-text">ETHUSD Chart</span></a> by TradingView</div>
                        </div>
                    </Grid>
                </Grid>
            </Grid>
